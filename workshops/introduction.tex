...
%\begin{frame}{Spring 2021 CRC HPC Workshop Series}
%\begin{table}
%\begin{tabular}{ll}
%Date     & Workshop\\
%\hline
...
%\end{tabular}
%\caption{Workshops will be held each Thursday via Zoom from 12:00 to 2:00 PM. Register
%to receive Zoom coordinates. Sessions will be recorded and posted along with
%session materials. \href{https://smu.az1.qualtrics.com/jfe/form/SV_dnm11WL26HOyeLY}{Register!}}
%\end{table}
%\end{frame}
