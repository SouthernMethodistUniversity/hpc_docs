...
\author{John LaGrone\\Robert Kalescky\\ HPC Applications Scientists}
\institute{
...
\input{common/mpi.tex}
\input{common/mpi4py.tex}
\input{common/nccl.tex}
\input{common/nvshmem.tex}
