...
local sif_file = '/hpc/m3/containers/kbnk/kbnk_1.0.sif'

local work_dir = '/work'
local scratch_dir = os.getenv("SCRATCH")
local home = os.getenv("HOME")
local user_libs = pathJoin(home, 'kbnk/R/4.5.1')
...
setenv('CONTAINER_IMAGE', '/hpc/m3/containers/kbnk/kbnk_1.0.sif')
