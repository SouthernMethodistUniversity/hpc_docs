...
if (container_name == "") then
   ...
   build_command("runwb2", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/Framework/bin/Linux64/")
   build_command("fluent", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/fluent/bin")
   build_command("mapdl", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/ansys/bin/")
   build_command("ansys251", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/ansys/bin/")
   build_command("autodyn", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/autodyn/bin/")
   build_command("cfx5", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/CFD-Post/bin/")
   build_command("ansysedt", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/AnsysEM/")
   build_command("siwave", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/AnsysEM/")
   build_command("polyflow", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/polyflow/bin/")
  ...
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/Framework/bin/Linux64/")
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/fluent/bin/")
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/ansys/bin/")
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/autodyn/bin/")
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/CFD-Post/bin/")
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/AnsysEM/")
  append_path("PATH", "/hpc/m3/apps/ansys/25R1/ansys_inc/v251/polyflow/bin/")
