...
if (container_name == "") then
   ...
   prepend_path("APPTAINERENV_PREPEND_PATH","/hpc/m3/apps/Matlab/2026a/bin")
   setenv("APPTAINERENV_MATLABROOT","/hpc/m3/apps/Matlab/2026a")
   ...
   build_command("matlab", "/hpc/m3/apps/Matlab/2026a/bin")
  ...
  -- not work
  prepend_path("PATH","/hpc/m3/apps/Matlab/2026a/bin")
  prepend_path("LD_LIBRARY_PATH","/hpc/m3/apps/Matlab/2026a/bin/glnxa64/")
  setenv("MATLABROOT","/hpc/m3/apps/Matlab/2026a")
