...
whatis("Name: R")
whatis("Version: geospatial:4.5.1")
whatis("Category: R")
...
local sif_file = '/hpc/m3/containers/rocker/rocker_geospatial_4.5.1.sif'

local work_dir = '/work'
local scratch_dir = os.getenv("SCRATCH")
local home = os.getenv("HOME")
local user_libs = pathJoin(home, 'R/rocker/4.5.1')
...
setenv('CONTAINER_IMAGE', '/hpc/m3/containers/rocker/rocker_geospatial_4.5.1.sif')
