...
:::{important} Beginning **February 25, 2026**, SMU will be transitioning from Duo to Microsoft Authenticator as the primary multi-factor authentication method. During this transition period, some services may still require Duo authentication. For more information, please visit the [Microsoft Authenticator](https://www.smu.edu/oit/services/microsoft-authenticator) page.
:::
